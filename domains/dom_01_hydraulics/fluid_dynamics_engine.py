...
TOOL_PRESSURE_DROP = ToolSpec(
    ...
    inputs=[
        InputSpec("rho", "Fluid Density", default=1000.0, min_value=0.01,
                   quantity_kind="density", canonical_unit="kg/m3"),
        InputSpec("velocity", "Flow Velocity", default=2.0, min_value=0.001,
                   quantity_kind="velocity", canonical_unit="m/s"),
        InputSpec("diameter", "Pipe Internal Diameter", default=0.1, min_value=0.001,
                   quantity_kind="length", canonical_unit="m"),
        InputSpec("length", "Pipe Length", default=100.0, min_value=0.1,
                   quantity_kind="length", canonical_unit="m"),
        InputSpec("viscosity", "Dynamic Viscosity", default=0.001, min_value=1e-6,
                   quantity_kind="viscosity_dynamic", canonical_unit="Pa.s"),
        InputSpec("roughness", "Absolute Roughness", default=0.000045, min_value=0.0, unit="(m)",
                   help="Left as a plain field this round - not yet retrofitted with a unit selector."),
    ],
